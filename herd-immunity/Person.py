...
class Person:
    ...
    def did_survive_infection(self):
        ...
        virus's mortality_num. If the random number is smaller, person dies
        from the disease. Set the person's is alive attribute to False
        ...
        '''
        self.randnum = random.randrange(0.0, 1.0)

        if self.randnum < self.infection.mortality_num:
            self.is_alive = False
            return False
        else:
